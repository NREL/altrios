...
1. Open git bash, and inside the directory you created,
   ...
   the [ALTRIOS repository](https://github.com/NatLabRockies/ALTRIOS) with e.g. `git clone
https://github.com/NatLabRockies/ALTRIOS.git`.
...
workflows](https://github.com/NatLabRockies/altrios/tree/main/.github/workflows) are triggered.
...
1. Update the version number in the `pyproject.toml` file. Commit and push to
   https://github.com/NatLabRockies/altrios.
...
1. Once the pull request is merged into the main branch by a reviewer, create a new GitHub release
   ...
   action](https://github.com/NatLabRockies/altrios/blob/686e8c28828cb980cc45567d08091e69b7bee52c/.github/workflows/wheels.yaml#L5)
...
1. Increment the version number in
   [altrios-core/Cargo.toml](https://github.com/NatLabRockies/altrios/blob/426f50e4ebd0fbf1d7e346aa31604107df8f83fe/altrios-core/Cargo.toml#L8): 
...
1. Push the tag with `git push public ac<major>.<minor>.<patch>`, where `public` is this remote:
   `git@github.com:NatLabRockies/altrios.git`.
...
1. Increment the version number in
   [Cargo.toml](https://github.com/NatLabRockies/altrios/blob/dced44b42c456da88363d03dc43259b039a94e6d/Cargo.toml#L48):
