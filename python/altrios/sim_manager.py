...
def main(
    ...
    debug: bool = False,
    loco_pool: pl.DataFrame | None = None,
    refuelers: pl.DataFrame | None = None,
    grid_emissions_factors: pl.DataFrame | None = None,
    nodal_energy_prices: pl.DataFrame | None = None,
    ...
    demand_file: pl.DataFrame | Path | str = str(defaults.DEMAND_FILE),
