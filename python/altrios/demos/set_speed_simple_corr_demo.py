...
loco0 = tsb.loco_con.loco_vec.tolist()[0]
...
network = alt.Network.from_file('C:/Users/ds57534/Documents/GitHub/altrios-private/python/altrios/resources/networks/simple_corridor_network.yaml')
...
link_path = alt.LinkPath.from_csv_file("C:/Users/ds57534/Documents/GitHub/altrios-private/python/altrios/resources/demo_data/link_points_idx_simple_corridor.csv")


speed_trace = alt.SpeedTrace.from_csv_file(
    "C:/Users/ds57534/Documents/GitHub/altrios-private/python/altrios/resources/demo_data/speed_trace_simple_corridor.csv"
)
...
# if loco0.res is not None:
#     ax[2].plot(np.array(train_sim.history.time_seconds) / 3_600, loco0.res.history.soc)
