...
def convert_demand_to_sim_days(
    demand_table: pl.DataFrame | pl.LazyFrame,
    simulation_days: int,
...
def load_freight_demand(
    demand_table: pl.DataFrame | pl.LazyFrame | Path | str,
...
def prep_hourly_demand(
    total_demand: pl.DataFrame | pl.LazyFrame,
    hourly_demand_density: pl.DataFrame | pl.LazyFrame,
    daily_demand_density: pl.DataFrame | pl.LazyFrame,
    simulation_weeks=1,
) -> pl.DataFrame | pl.LazyFrame:
...
def build_locopool(
    config: planner_config.TrainPlannerConfig,
    demand_file: pl.DataFrame | pl.LazyFrame | Path | str,
    dispatch_schedule: pl.DataFrame | pl.LazyFrame = None,
    method: str = "tile",
    shares: list[float] = [],
