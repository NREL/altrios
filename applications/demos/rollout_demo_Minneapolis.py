...
#     max_bel_share=0,
#     number_of_years=100, 
#     results_folder = '../../Case Study/Convention Freight Rollout Results Minneapolis',
#     demand_file_path='../../Case Study/Minneapolis Base Demand.csv',
...
# DemandFiles = glob.glob('../../Case Study/Convention Freight Rollout Results Minneapolis/Minneapolis*.csv')
DemandFiles = ["../../Case Study/Convention Freight Rollout Results Minneapolis/Minneapolis Base Demand2068.csv",
    "../../Case Study/Convention Freight Rollout Results Minneapolis/Minneapolis Base Demand2045.csv",
    "../../Case Study/Convention Freight Rollout Results Minneapolis/Minneapolis Base Demand2055.csv"]
...
for File in DemandFiles:
    ...
    scenario_infos, metrics = rollout.simulate_prescribed_rollout(
        max_bel_share=.8,
        number_of_years=31, 
        results_folder = '../../Case Study/Rollout Results Minneapolis',
