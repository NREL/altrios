...
from altrios.train_planner import data_prep, planner_config
...
def initialize_reverse_empties(demand: pl.LazyFrame | pl.DataFrame) -> pl.LazyFrame | pl.DataFrame:
    """
...
def generate_return_demand_unit(demand_subset: pl.LazyFrame | pl.DataFrame, config: planner_config.TrainPlannerConfig) -> pl.LazyFrame | pl.DataFrame:
    """
...
def generate_return_demand_manifest(demand_subset: pl.LazyFrame | pl.DataFrame, config: planner_config.TrainPlannerConfig) -> pl.LazyFrame | pl.DataFrame:
    """
...
def generate_return_demand_intermodal(demand_subset: pl.LazyFrame | pl.DataFrame, config: planner_config.TrainPlannerConfig) -> pl.LazyFrame | pl.DataFrame:
    """
