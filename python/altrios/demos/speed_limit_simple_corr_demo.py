...
network = alt.Network.from_file(
    alt.resources_root() / 'networks/simple_corridor_two_segment_network.yaml')
...
link_path = alt.LinkPath.from_csv_file(
    alt.resources_root() / "demo_data/link_points_two_segment.csv")


# speed_trace = alt.SpeedTrace.from_csv_file(
#     alt.resources_root() / "demo_data/speed_trace_simple_corridor.csv"
# )
location_map = alt.import_locations(alt.resources_root() / "networks/simple_corridor_two_segment_locations.csv")
