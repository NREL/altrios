...
df_timed_paths = pd.read_csv('TimedPaths.csv')
train_idx = 1
...
results_path = alt.package_root() / "../../applications/demos/results/"
...
for i, ts in enumerate(train_sims):
    ...
    ts.to_file(
        str(results_path / 'speed_limit_train_sim_results_{}.json'.format(i))
    )
# %%
